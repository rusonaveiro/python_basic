...
# crea un diccionario y una tabla en sql con datos de usuarios
...
def datos():
    ...
    cursor = base.cursor()
    cursor.execute("CREATE TABLE producto( id int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, titulo VARCHAR(128) COLLATE utf8_spanish2_ci NOT NULL, ruta varchar(128) COLLATE utf8_spanish2_ci NOT NULL, descripcion text COLLATE utf8_spanish2_ci NOT NULL )")
    global inscrip
...
# se crea la db al apretar el boton
def creadordb():
    base = mysql.connector.connect(
        user='root',
        passwd='root',
